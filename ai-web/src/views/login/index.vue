        ...
        .then(res => {
          if (res.success) {
            ...
            return initRouter().then(() => {
              ...
              console.log("准备跳转的目标路径：", targetPath);

              router
                .push(targetPath)
                .then(() => {
                  console.log("✅ router.push 成功完成");
                  console.log("当前路由 path：", router.currentRoute.value.path);
                })
                .catch(err => {
                  console.error("❌ router.push 被中断", err);
                });
            });
          } else {
    ...
    <div class="login-container">
      ...
      <div class="login-box">
        <div class="login-form">
          <!-- <avatar class="avatar" /> -->
          <img src="@/assets/login/logo.png" style="height: 100 px" />
          <el-divider> 智慧学习管理系统 </el-divider>
          <!-- <Motion>
