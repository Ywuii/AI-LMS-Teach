<template>
  <div class="maincontent">
    ...
    <el-form ref="formRef" :inline="true" :model="form" class="searchform">
      <el-form-item label="AI模块：" prop="request_modular">
        <!-- <el-input v-model="form.creator" placeholder="请输入用户名称" clearable class="!w-[180px]" /> -->
        <el-select v-model="form.request_modular" placeholder="请选择" clearable class="!w-[180px]">
          <el-option label="在线学习助手" value="在线学习助手" />
          <el-option label="实时练习评测助手" value="实时练习评测助手" />
          <el-option label="测试题生成专家" value="测试题生成专家" />
          <el-option label="教学方案设计专家" value="教学方案设计专家" />
          <el-option label="实践报告评阅专家" value="实践报告评阅专家" />
        </el-select>
      </el-form-item>
      ...
      <el-form-item>
        ...
        <el-button :icon="useRenderIcon('ri:delete-bin-2-line')" type="danger" @click="clearall()"> 清空记录 </el-button>
      </el-form-item>
    </el-form>
    <!-- 表格数据区域 -->
    <div ref="tableContainer" class="table">
      <el-table :data="dataList" class="el-table" :height="tableMaxHeight" :show-overflow-tooltip="true">
        ...
        <el-table-column prop="creator" label="用户名" align="center" width="120px" />
        <el-table-column prop="request_ip" label="IP地址" align="center" width="150px" />
        <el-table-column prop="request_method" label="请求方法" align="center" width="80px" />
        <el-table-column prop="request_modular" label="功能模块" align="center" width="150px" />
        ...
        <el-table-column prop="request_body.question" label="问题 | 知识点" align="center" />
        ...
        <el-table-column prop="create_time" label="操作时间" align="center" width="180px" />
