import Axios, { InternalAxiosRequestConfig, type AxiosInstance, type AxiosRequestConfig, type CustomParamsSerializer } from "axios";
...
class PureHttp {
  ...
  public request<T>(method: RequestMethods, url: string, param?: AxiosRequestConfig, axiosConfig?: PureHttpRequestConfig): Promise<T> {
    const config = {
      ...
      ...param,
      ...axiosConfig,
      timeout: axiosConfig?.timeout ?? 300000,
